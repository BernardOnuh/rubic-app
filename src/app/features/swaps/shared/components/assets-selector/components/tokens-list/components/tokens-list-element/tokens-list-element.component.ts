...
import { ETHEREUM_PLATFORM_TOKEN_ADDRESS } from '@shared/constants/blockchain/platform-token-address';
...
export class TokensListElementComponent implements OnInit {
  ...
  public get isPlatformToken(): boolean {
    return compareAddresses(this.token.address, ETHEREUM_PLATFORM_TOKEN_ADDRESS);
  }
